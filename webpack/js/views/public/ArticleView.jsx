...
export default class ArticleView extends Component {
    ...
    render() {
        ...
        this.props.articles_popular.map((element) => {
            popular_articles.push(
                <div key={element.id + element.name}>
                    <h5 className="articles-popular__name">{element.name}</h5>
        ...
        if (this.props.prev) {
            prev =
                <ReactiveLink href={this.props.prev} className="article-content__left">
                    <i className='mdi mdi-arrow-left'/> Предыдущая статья
                </ReactiveLink>
        }
        ...
        if (this.props.next) {
            next =
                <ReactiveLink href={this.props.next} className="article-content__right">
                    Следующая статья <i className='mdi mdi-arrow-right'/>
                </ReactiveLink>
        }
                        ...
                        <Cell>
                            <div className='page article-page'>
                                ...
                                <Row>
                                    ...
                                    <Cell sm="1-3">
                                        <h2 className="article-page__header">Интересные статьи</h2>
                                    </Cell>
                                </Row>
                                <Row className="article-page__row">
                                    ...
                                    <Cell className="article-page__mobile">
                                        <h2 className="article-page__header">Интересные статьи</h2>
                                    </Cell>
