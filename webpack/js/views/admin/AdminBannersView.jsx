...
export default class AdminBannersView extends Component {
    render() {
        let block = '';
...
class Index extends Component {
    render() {
        ...
        if (this.props.banners && this.props.banners.length > 0) {
            banners = this.props.banners.map((element) => {
                return (
                    <tr key={element.id}>
                        <td>
                            <img className="preview-image--min" src={element.preview_image.src}/>
                        </td>
                        <td className="center ">
            ...
            content = <p>Баннеры не найдены</p>
        }
...
class New extends Component {
    render() {
        return (
            <BannersForm formAction="/admin/banners" method="post" {...this.props} />
        );
    }
}
...
class Edit extends Component {
    render() {
        return (
            <BannersForm formAction={this.props.form.control_url} method="put" {...this.props} />
        );
    }
}
    ...
    render() {
        ...
        return (
            <Form action={this.props.formAction} method={this.props.method} withFiles={true}>
                ...
                <h2>Фото</h2>
                <ImageSelect name="banner[media_file_id]" url="/admin/media_library/banners"
                             value={this.props.form.preview_image}/>


                <Input label='Заголовок' type='text' value={this.props.form.header} name='banner[header]'/>
